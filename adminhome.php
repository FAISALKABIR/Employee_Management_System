		...
		*{margin:0;padding:0;}
		...
		h2 {
		  ...
		  text-decoration: underline;
		    ...
		    /*Parallax Area*/
		.parallax{
			background-image: url("image/adhome4.jpg");
			min-height: 500px; 
	...
	<div class="text-area fix">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<h3>Hello Admin ! <br/>
					Attendance & Leave Management</h3>
					<h2><a href="manageleave.php">Manage Leaves</a></h2>
					<h2><a href="adminleavehistory.php">History of Employees</a></h2>
				</div>	
			</div>
		</div>
	</div>
