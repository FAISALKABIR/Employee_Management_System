...
<head>
	<meta charset="UTF-8">
	<title>Admin Read Leave History</title>
	...
	<div class="table-area fix">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
				<article>
				<h2>Leave History of Employee:</h2>
					<table class="application">
						...
						<tbody>	
							<tr>
								...
								<td><i class="fa fa-thumbs-up" aria-hidden="true">Approved</i></td>
							</tr>
							<tr>
								<td>001</th>
								<td>15/12/2017</td>
						...
						<tfoot>
							<tr>
								<td colspan="6">
									<p><strong>Total leaves in a year are : 20 Days</strong></p>
							        <p><strong>Total leaves taken till now are : 8 Days</strong></p>
									<p><strong>Remaining leaves are : 12 Days</strong></p>
								</td>
							</tr>
						</tfoot>
					</table>
